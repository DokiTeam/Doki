...
+ **The [legacy](https://github.com/DokiTeam/Doki/tree/legacy) branch will be the main branch. It will be suitable for Android API 21+ / Android 5.0+ devices.**<br>
+ **The [base](https://github.com/DokiTeam/Doki/tree/base) branch will be the secondary branch. It will be suitable for Android API 23+ / Android 6.0+ devices**
